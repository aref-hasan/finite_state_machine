#Start command manim -pql --disable_caching scenes_a_copy.py objects
...
class objects(VoiceoverScene, MovingCameraScene):
    def construct(self):
        ...
        circle_color = WHITE
#scene_1
        ###Declaration of the eplanation for the akzeptor
...
#scene_5
    ...
    ###show the table    
        ...
        self.clear()
        t_wiedersehen = Tex("Vielen Dank für eure Aufmerksamkeit").move_to([0,0,0])
